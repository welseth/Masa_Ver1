CREATE TABLE [dbo].[Flights] (
    ...
    [Glider_Pilot_Name]      INT      NOT NULL,
    ...
    [AOD1]                   INT      NULL,
    [AOD2]                   INT      NULL,
    [TowPilot1]              INT      NOT NULL,
    [TowPilot2]              INT      NULL,
    [TowPilot3]              INT      NULL,
    [TowPlane1]              INT      NOT NULL,
    [TowPlane2]              INT      NULL,
    [Date]                   DATE     NOT NULL,
    [Glider_takeoff_time]    TIME (0) NOT NULL,
    [Glider_landing_time]    TIME (0) NOT NULL,
    [Tow_takeoff_time]       TIME (0) NULL,
    [Tow_landing_time]       TIME (0) NULL,
    [Altitude_towed]         INT      NOT NULL DEFAULT 3000,
    [Rope_break]             BIT      NULL,
    [Airport_name]           INT      NOT NULL,
    [Flight_minutes]         TIME (0) NULL,
    [First_name_on_invoice]  INT      NOT NULL,
